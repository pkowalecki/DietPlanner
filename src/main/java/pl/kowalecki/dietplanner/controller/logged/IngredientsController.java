...
public class IngredientsController {
    ...
    public ResponseEntity<List<IngredientName>> searchIngredients(@RequestParam("query") String query, HttpServletRequest request, HttpServletResponse response) {
        ...
        if (apiResponse.getBody() != null) {
            ...
            List<IngredientName> ingredientNames = classMapper.convertToDTOList(ingredientNamesList, IngredientName.class);
